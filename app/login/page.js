    ...
    <div className="flex min-h-screen items-center justify-center mt-[-50px]">
      <div className=" p-6 rounded shadow w-80 text-center">
        ...
        <button
          ...
          className="mb-3 w-full bg-red-500 cursor-pointer text-white py-2 rounded"
        >
          Sign in with Google
        </button>
        <button
          onClick={() => signIn("github")}
          className="w-full bg-gray-800 cursor-pointer text-white py-2 rounded"
        >
          Sign in with GitHub
        </button>
      </div>
...
<div className="mt-[150px] max-w-3xl mx-auto text-center">
