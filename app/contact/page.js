...
const contact = () => {
  return (
    <>
    <div>
      <section id="contact" className="px-4 py-12 bg-transparent text-white text-center">
...
<div className="mt-[350px] max-w-3xl mx-auto text-center">
...
export default contact
>>>>>>> aace166e76eba47629756b7ff558d67bb40e64a0
